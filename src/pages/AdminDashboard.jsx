...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="md:flex md:items-center md:justify-between mb-8">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-300 text-sm">Welcome back! Here's an overview of your accommodation system.</p>
            </div>
      ...
      {error && (
        <div className="mt-4 bg-gray-100 border-l-4 border-black p-4 rounded-r-lg animate-fade-in">
          <div className="flex">
      ...
      {activeTab === 'overview' && (
        <>
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Link
              to="/admin/rooms"
              className="group relative rounded-xl border border-gray-200 bg-white px-6 py-5 shadow-sm transition-all duration-300 hover:shadow-lg hover:border-black focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-black"
            >
              <div className="flex items-center space-x-4">
                <div className="flex-shrink-0 bg-gray-100 rounded-lg p-3 group-hover:bg-gray-200 transition-colors duration-300">
